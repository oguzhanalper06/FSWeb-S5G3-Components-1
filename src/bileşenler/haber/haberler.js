...
function haberYapici(haber) {
  const articleO = document.createElement("div");
  articleO.classList.add("article");

  const h2O = document.createElement("h2");
  h2O.textContent = haber.baslik;
  articleO.appendChild(h2O);

  const tarihO = document.createElement("p");
  tarihO.classList.add("tarih");
  tarihO.textContent = haber.tarih;
  articleO.appendChild(tarihO);

  const paragraf1 = document.createElement("p");
  paragraf1.textContent = haber.ilkParagraf;
  articleO.appendChild(paragraf1);

  const paragraf2 = document.createElement("p");
  paragraf2.textContent = haber.ikinciParagraf;
  articleO.appendChild(paragraf2);

  const paragraf3 = document.createElement("p");
  paragraf3.textContent = haber.ucuncuParagraf;
  articleO.appendChild(paragraf3);

  const expandButtonO = document.createElement("span");
  expandButtonO.classList.add("expandButton");
  expandButtonO.textContent = "+";

  expandButtonO.addEventListener("click", (event) => {
    const acikHaber = document.querySelector(".article-open");
    articleO.classList.toggle("article-open");
  });

  articleO.appendChild(expandButtonO);
  return articleO;
}
